...
export default function Guerra_dos_5_Reinos() {
    return (
        <main className={Wiki.main}>
            <div className={Wiki.desc}>
                ...
                <ItemWiki titulo="" desc="Os anões, que já moravam em grande parte no norte fizeram certeza de trazer seu povo para esse território. Contra os humanos, fizeram um tratado com os elfos de que haveria paz e que lutariam juntos." />
                <h3>Estado atual:</h3>
                <ItemWiki titulo="" desc="Tudo isso aconteceu durante os 52 anos de guerra, até chegarmos aos dias atuais. O nome do continente permanece o nome do reino continental antigo, Algihand, porém a separação persiste." />
            </div>
        </main>
    )
}